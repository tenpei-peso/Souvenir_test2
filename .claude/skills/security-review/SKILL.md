...
description: 認証・認可、シークレット、支払い、ファイルアップロード、未検証入力、公開 API や Webhook など高リスク境界を追加・変更するときに使う。通常の CRUD や一般 UI 変更では使わない。
---
...
- 認証が必要な API エンドポイントや公開 Webhook の作成
- シークレットまたは資格情報の操作
- 支払い機能の実装
- 機密データの保存または送信
- 権限の強いサードパーティ API や外部サービスの統合
