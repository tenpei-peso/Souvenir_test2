---
name: tdd-workflow
description: ユーザーがテストファーストや TDD を明示したとき、または先にテストを追加してから進めたいときだけ使う手動ワークフロー。通常の実装タスクでは自動適用しない。
disable-model-invocation: true
---

# テスト駆動開発ワークフロー

このスキルは、TDD で進めると明示されたタスクを手動で進めるためのワークフローです。

## 有効化するタイミング

- ユーザーが TDD またはテストファーストを要求したとき
- 実装前に失敗するテストを先に作りたいとき
- 既存変更に対して不足しているテストを追加し直したいとき
- カバレッジ改善が主タスクのとき
